...
interface Analytics {
  ...
  sentences: string[];
  sentiment: string;
  highlight_indices: (string | number)[][]
}

function ReviewHighlight({ analytics} : { analytics: Analytics[] }) {
  return (
    <>
      {/* {content}
      {analytics} */}
  ...
  return (
    <div className=' '>
      {reviews.map((review, index) => (
        <div className='mx-48 mb-20 mt-3' key={index}>


          <div className='flex space-x-7'>
            <div>
              <img src="http://devinnspire.accessai.co:8001/media/sources/booking3.png" alt="Image" style={{ maxWidth: '100px', maxHeight: '100px' }}
              />
            </div>
            ...
            <div className='space-y-5'>
              <div>
                <p> <strong>{review.reviewer_name}</strong> wrote a review about <strong>{review.source.name}</strong>  </p>
              </div>

              <div className='flex space-x-20'>
                <div className='flex space-x-1'>
                  <img src="https://cdn-icons-png.flaticon.com/128/1828/1828884.png" alt="star" className='w-6 h-6' />
                  <img src="https://cdn-icons-png.flaticon.com/128/1828/1828884.png" alt="star" className='w-6 h-6' />
                  <img src="https://cdn-icons-png.flaticon.com/128/1828/1828884.png" alt="star" className='w-6 h-6' />
                  <img src="https://cdn-icons-png.flaticon.com/128/1828/1828884.png" alt="star" className='w-6 h-6' />
                  <img src="https://cdn-icons-png.flaticon.com/128/1828/1828884.png" alt="star" className='w-6 h-6' />
              ...
              <ReviewHighlight analytics={review.analytics} />
            </div>
